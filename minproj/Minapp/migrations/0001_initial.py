# Generated by Django 4.2.3 on 2023-09-22 12:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(error_messages={'required': 'Обязательное поле', 'unique': 'Группа с таким названием уже существует'}, max_length=255, unique=True, verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Minapp.group')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('photo', models.CharField(blank=True, null=True, verbose_name='Фотография')),
                ...
                ('groups', models.ManyToManyField(through='Minapp.UserGroups', to='Minapp.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(error_messages={'required': 'Обязательное поле', 'unique': 'Учреждение с таким названием уже существует'}, max_length=255, unique=True, verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(blank=True, null=True, verbose_name='Дата/время')),
                ...
                ('is_check', models.BooleanField(default=True, verbose_name='Согласовано')),
                ('is_finished', models.BooleanField(default=False, verbose_name='Выполнено')),
                ('photo', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='', verbose_name='Фотография'), blank=True, default=list, null=True, size=None)),
                ('group_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Minapp.group', verbose_name='Группа')),
                ('location_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Minapp.location', verbose_name='Учреждение')),
                ('recipient_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Получатель')),
            ],
            options={
