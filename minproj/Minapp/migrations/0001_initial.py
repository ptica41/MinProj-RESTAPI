    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_id', models.CharField(blank=True, help_text='Только для операторов', null=True, verbose_name='Ведомство')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_check', models.BooleanField(default=False, verbose_name='Проверка')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активный пользователь?')),
                ('department_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Minapp.department')),
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(error_messages={'required': 'Обязательное поле', 'unique': 'Ведомство с таким названием уже существует'}, help_text='Введите название учреждения', max_length=255, unique=True, verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Minapp.recipient', verbose_name='Получатель')),
            ],
            options={
